...
const Login = () => {
  ...
  return (
    <div className="loginContainer">
      <img
        className="loginContainer__img"
        src="https://redeamerica.org/Portals/_default/skins/2023/img/Logo.svg"
        alt=""
      />
      <span>Potenciando el Intercambio Educativo en RedEAmérica</span>
      <form className="loginContainer__form" onSubmit={handleSubmit(userLogin)}>
        ...
        <label className="loginContainer__form--label">Email</label>
        <input
          type="email"
        ...
        />
        <label className="loginContainer__form--label">Contraseña</label>
        <input
          type="password"
          className="loginContainer__form--input"
          name="password"
      ...
      <div className="loginContainer__pageRegister">
        ...
        <Link to="/registro" className="loginContainer__pageRegister--link">
          <em>Registrarse</em>
        </Link>
      </div>
      <SesionRedes />
